#!/bin/sh
###
 # @Date: 2026-05-02 16:11:25
 # @LastEditors: Guailoudou guailoudou@outlook.com
 # @LastEditTime: 2026-05-02 16:12:19
 # @FilePath: \undefinedd:\web\gitfileurl\urlfile\file\opl_lu2.sh
### 
getfilename(){
    sysType=$(uname -s)
    echo "system: ${sysType}"
...
dmopl(){
    ...
    url="https://file.gldhn.top/file/console/opl-console-$sysType.tar.gz"
